...
class AdminController extends Controller {
    ...
    public function productNewSaveAction(Request $request) {
        $productRepos = $this->getDoctrine()->getRepository('ClosasShopBundle:Product');
    ...
    public function savePriceTextAction(Request $request) {
        ...
        foreach ($arr_data as $name => $data) {
            ...
            if ($field[0] == 'descriptionname') {
                $reposCommon = $this->getDoctrine()->getRepository('ClosasShopBundle:' . $arr_fields[$field[0]]);
        ...
        foreach ($arr_data as $names => $data) {
            ...
            foreach ($arr_name as $name) {
                foreach ($arr_fields as $field => $entity) {
                    $reposCommon = $this->getDoctrine()->getRepository('ClosasShopBundle:' . $entity);
                }
            }
        }
    }
    ...
    public function deleteAction(Request $request) {
        ...
        $reposProduct = $this->getDoctrine()->getRepository('ClosasShopBundle:Product');
        $product = $reposProduct->findOneById($product_id);
        $reposImage = $this->getDoctrine()->getRepository('ClosasShopBundle:Product\Image');
    ...
    public function deleteElement(Request $request) {
        ...
        $reposDescription = $this->getDoctrine()->getRepository('ClosasShopBundle:Product\Description');
        ...
        $reposPrice = $this->getDoctrine()->getRepository('ClosasShopBundle:Price');
        ...
        $reposProductAdditional = $this->getDoctrine()->getRepository('ClosasShopBundle:Map\ProductAdditional');
    ...
    public function setImageDefaultAction(Request $request) {
        ...
        $reposProductImage = $this->getDoctrine()->getRepository('ClosasShopBundle:Product\Image');
    ...
    public function setElementUpdateAction(Request $request) {
        ...
        $html = '';
        $reposProductDescription = $this->getDoctrine()->getRepository('ClosasShopBundle:Product\Description');
        foreach ($productdescriptions as $child_id => $arr_productdescription) {
            ...
            foreach ($productprices[$child_id] as $product_price_id => $productprice) {
                $price = $this->getDoctrine()->getRepository('ClosasShopBundle:Price')->findOneById($product_price_id);
    ...
    protected function saveUploadImage($files, $product, $priorOriginalName = '') {
        ...
        foreach ($files as $file) {
            ...
            $reposSize = $this->getDoctrine()->getRepository('ClosasShopBundle:Product\Image\Size');
