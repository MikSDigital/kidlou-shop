...
use Closas\ShopBundle\Entity\Deliver\Standard;
use Closas\ShopBundle\Entity\Deliver;
...
class DeliverController extends Controller {
    ...
    public function standardindexAction(Request $request) {
        ...
        $reposStandard = $this->getDoctrine()->getRepository('ClosasShopBundle:Deliver\Standard');
    ...
    public function exceptionupdateAction($datum, $isdeliver) {
        $em = $this->getDoctrine()->getManager();
        $deliver = $this->getDoctrine()->getRepository('ClosasShopBundle:Deliver')->findOneBy(array('date' => new \DateTime($datum)));
        if (!$deliver) {
            $deliver = new Deliver();
