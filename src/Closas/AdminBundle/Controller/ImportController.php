...
use Closas\ShopBundle\Helper\ImageResizer;
...
class ImportController extends Controller {
    ...
    protected function prepareProduct() {
        $em = $this->getDoctrine()->getManager();
        $products = $this->getDoctrine()->getRepository('ClosasShopBundle:Product')->findAll();
    ...
    protected function deleteAllImages() {
        $images = $this->getDoctrine()->getRepository('ClosasShopBundle:Product\Image')->findAll();
...
//        $price->setDay(0);
    ...
    protected function _setAdditionals() {
        ...
        $reposProductGroup = $this->getDoctrine()->getRepository('ClosasShopBundle:Map\ProductGroup');
        $em = $this->getDoctrine()->getManager();
