...
class PaymentController extends Controller {
    ...
    public function listAction() {
        $payments = $this->getDoctrine()->getRepository('ClosasShopBundle:Payment')->findAll();
    ...
    public function cautionAction(Request $request) {
        $caution = $this->getDoctrine()->getRepository('ClosasShopBundle:Caution')->findAll();
        if ($caution) {
    ...
    public function shippingAction($id = null, Request $request) {
        if ($id != null) {
            $shipping = $this->getDoctrine()->getRepository('ClosasShopBundle:Shipping')->findOneById($id);
        } else {
    ...
    public function shippinglistAction() {
        $shippings = $this->getDoctrine()->getRepository('ClosasShopBundle:Shipping')->findBy(array(), array('price_limit' => 'ASC'));
    ...
    private function getPaymentTyp($payment) {
        return $this->getDoctrine()->getRepository('ClosasShopBundle:Payment\\' . $payment->getName())
    ...
    private function getAllLanguages() {
        $languages = $this->getDoctrine()->getRepository('ClosasShopBundle:Language')->findAll();
    ...
    private function getPaymentLabel($payment, $request, $lang) {
        ...
        $lang = $this->getDoctrine()->getRepository('ClosasShopBundle:Language')->findOneBy(array('short_name' => $lang));
        if (isset($arr_form['lang_short_name'])) {
            $lang = $this->getDoctrine()->getRepository('ClosasShopBundle:Language')->findOneBy(array('short_name' => $arr_form['lang_short_name']));
        }
        return $this->getDoctrine()->getRepository('ClosasShopBundle:Payment\Lang\Label')
    ...
    private function getImage($payment) {
        $label = $this->getDoctrine()->getRepository('ClosasShopBundle:Payment\Lang\Label')
    ...
    private function deleteFile($request) {
        ...
        if (isset($names)) {
            ...
            foreach ($names as $name) {
                $image = $this->getDoctrine()->getRepository('ClosasShopBundle:Image')->findOneBy(array('name' => $name));
// remove File from filesystem
                ...
                $labels = $this->getDoctrine()->getRepository('ClosasShopBundle:Payment\Lang\Label')
    ...
    private function setPasswordFromEntity($payment) {
        $paymentTyp = $this->getDoctrine()->getRepository('ClosasShopBundle:Payment\\' . $payment->getName())->findOneBy(array('payment' => $payment));
        $name = '\Closas\ShopBundle\Entity\Payment\\' . $payment->getName();
