 ...
 * @ORM\Entity(repositoryClass="Closas\ShopBundle\Entity\Repository\Content")
 */
class Content {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Closas\ShopBundle\Entity\Language", inversedBy="contents")
     * @ORM\JoinColumn(name="lang_id", referencedColumnName="id")
     */
    private $lang;

    /**
     * @ORM\ManyToMany(targetEntity="Closas\ShopBundle\Entity\Category", mappedBy="contents")
     */
    private $categories;

    /**
     * @ORM\ManyToOne(targetEntity="Closas\AdminBundle\Entity\User", inversedBy="contents")
     * @ORM\JoinColumn(name="user_id", referencedColumnName="id")
     */
    private $user;

    /**
     * @ORM\ManyToMany(targetEntity="Closas\ShopBundle\Entity\Image", inversedBy="contents")
     * @ORM\JoinTable(name="contents_images")
     */
    private $images;

    /**
     * @ORM\ManyToOne(targetEntity="Closas\ShopBundle\Entity\Content\Group", inversedBy="contents")
     ...
     * Set user
     *
     * @param \Closas\AdminBundle\Entity\User $user
     *
     * @return Content
     */
    public function setUser(\Closas\AdminBundle\Entity\User $user = null) {
        $this->user = $user;
     ...
     * Get user
     *
     * @return \Closas\AdminBundle\Entity\User
     */
     ...
     * Set group
     *
     * @param \Closas\ShopBundle\Entity\Content\Group $group
     *
     * @return Content
     */
    public function setGroup(\Closas\ShopBundle\Entity\Content\Group $group = null) {
        $this->group = $group;
     ...
     * Get group
     *
     * @return \Closas\ShopBundle\Entity\Content\Group
     */
