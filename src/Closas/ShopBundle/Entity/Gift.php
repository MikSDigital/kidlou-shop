 ...
 * @ORM\Entity
 * @ORM\Table(name="gift")
 * @ORM\Entity(repositoryClass="Closas\ShopBundle\Entity\Repository\Gift")
 */
class Gift {
    ...
    /**
     * @ORM\OneToMany(targetEntity="Closas\ShopBundle\Entity\Gift\Coupon", mappedBy="gift")
     */
    private $coupons;

    /**
     * @ORM\OneToMany(targetEntity="Closas\ShopBundle\Entity\Gift\Text", mappedBy="gift")
     */
    private $texts;
     ...
     * @return Text
     */
    public function setText(\Closas\ShopBundle\Entity\Gift\Text $text) {
        $this->text = $text;
     ...
     * @return Gift
     */
    public function addText(\Closas\ShopBundle\Entity\Gift\Text $text) {
        $this->texts[] = $text;
     ...
     * @param \Closas\ShopBundle\Entity\Gift\Text $text
     */
    public function removeText(\Closas\ShopBundle\Entity\Gift\Text $text) {
