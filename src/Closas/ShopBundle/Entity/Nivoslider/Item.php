...
namespace Closas\ShopBundle\Entity\Nivoslider;
 ...
 * @ORM\Entity(repositoryClass="Closas\ShopBundle\Entity\Repository\Nivoslider\Item")
 */
class Item {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Closas\ShopBundle\Entity\Language", inversedBy="nivosliders")
     * @ORM\JoinColumn(name="lang_id", referencedColumnName="id")
     */
    private $lang;

    /**
     * @ORM\ManyToOne(targetEntity="Closas\ShopBundle\Entity\Nivoslider", inversedBy="items")
     ...
     * Set nivoslider
     *
     * @param \Closas\ShopBundle\Entity\Nivoslider $nivoslider
     *
     * @return Item
     */
    public function setNivoslider(\Closas\ShopBundle\Entity\Nivoslider $nivoslider = null) {
     ...
     * Get nivoslider
     *
     * @return \Closas\ShopBundle\Entity\Nivoslider
     */
