...
namespace Closas\ShopBundle\Entity\Order;
 ...
 * @ORM\Entity(repositoryClass="Closas\ShopBundle\Entity\Repository\Order\Address")
 */
class Address {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Closas\ShopBundle\Entity\Order", inversedBy="addresses")
     * @ORM\JoinColumn(name="order_id", referencedColumnName="id")
     */
    private $order;

    /**
     * @ORM\ManyToOne(targetEntity="Closas\UserBundle\Entity\User", inversedBy="addresses")
