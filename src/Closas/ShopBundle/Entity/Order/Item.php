 ...
 * @ORM\Entity(repositoryClass="Closas\ShopBundle\Entity\Repository\Order\Item")
 */
class Item {
    ...
    /**
     * @ORM\OneToMany(targetEntity="Closas\ShopBundle\Entity\Order", mappedBy="status")
     */
    private $orders;

    /**
     * @ORM\ManyToOne(targetEntity="Closas\ShopBundle\Entity\Calendar", inversedBy="order_items")
     ...
     * @return Item
     */
    public function setCalendar(\Closas\ShopBundle\Entity\Calendar $calendar = null) {
     ...
     * Get calendar
     *
     * @return \Closas\ShopBundle\Entity\Calendar
     */
