 ...
 * @ORM\Entity(repositoryClass="Closas\ShopBundle\Entity\Repository\Order\Payment")
 */
class Payment {
    ...
    /**
     * @ORM\OneToOne(targetEntity="Closas\ShopBundle\Entity\Order", inversedBy="payment")
