...
class Post {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Closas\ShopBundle\Entity\Payment", inversedBy="posts")
     * @ORM\JoinColumn(name="payment_id", referencedColumnName="id")
     */
    private $payment;

    /**
     * @ORM\OneToMany(targetEntity="Closas\ShopBundle\Entity\Payment\Lang\Label", mappedBy="post")
     */
    private $labels;
