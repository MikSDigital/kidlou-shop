...
use Closas\ShopBundle\Entity\Image As Fileimage;
...
class Image {
    ...
    private function init() {
        ...
        $this->imageSizes = $this->em->getRepository('ClosasShopBundle:Image\Size')->findAll();
    ...
    public function getImageByContent($id) {
        if ($id) {
            $content = $this->em->getRepository('ClosasShopBundle:Content')->findOneBy(array('id' => $id));
    ...
    public function getImageByEntity($entity, $id) {
        if ($id) {
            $_entity = $this->em->getRepository('ClosasShopBundle:' . $entity)->findOneBy(array('id' => $id));
