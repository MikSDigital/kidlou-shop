...
namespace Closas\ShopBundle\Helper\Payment\Typ;
...
class Paypal {
    ...
    private function getTotalPriceItems() {
        return $this->getEm()->getRepository('ClosasShopBundle:Order')->getTotalPriceItems($this->getCurrentOrder())['price'];
    }
    ...
    private function getItems() {
        return $this->getEm()->getRepository('ClosasShopBundle:Order')->getItemsByOrder($this->getCurrentOrder());
    }
    ...
    private function setPaymentTyp() {
        $payment = $this->getEm()->getRepository('ClosasShopBundle:Payment')->findOneBy(array('name' => 'Paypal'));
        $this->payment_typ = $this->getEm()->getRepository('ClosasShopBundle:Payment\Paypal')->findOneBy(array('payment' => $payment));
    }
    ...
    private function getShippingAddress() {
        $address = $this->getEm()->getRepository('ClosasShopBundle:Order\Address')->findOneBy(array('order' => $this->getCurrentOrder(), 'address_typ' => 'shipping'));
        return $address;
    }
