...
class Post {
    ...
    private function setPaymentTyp() {
        $payment = $this->getEm()->getRepository('ClosasShopBundle:Payment')->findOneBy(array('name' => 'Post'));
        $this->payment_typ = $this->getEm()->getRepository('ClosasShopBundle:Payment\Post')->findOneBy(array('payment' => $payment));
    }
