...
namespace Closas\UserBundle\Entity;
 ...
 * @ORM\Entity(repositoryClass="Closas\UserBundle\Entity\Repository\User")
 */
class User implements AdvancedUserInterface, \Serializable {
    ...
    /**
     * @ORM\OneToMany(targetEntity="Closas\UserBundle\Entity\User\Personal", mappedBy="user")
     */
    private $personals;

    /**
     * @ORM\OneToMany(targetEntity="Closas\ShopBundle\Entity\Order\Address", mappedBy="user")
     */
    private $addresses;
     ...
     * @param \Closas\UserBundle\Entity\User\Personal $personal
     */
    public function removeCategory(\Closas\UserBundle\Entity\User\Personal $personal) {
