...
use App\Entity\Nivoslider\Item;
use App\Entity\Nivoslider\Configuration;
...
class SliderController extends Controller {
    ...
    public function indexAction($typ = '') {
        ...
        $nivoslider = $this->getDoctrine()->getRepository(Nivoslider\Configuration::class)->findFirst();
        if ($nivoslider) {
    ...
    public function itemnivoAction($id = null, Request $request) {
        ...
        if ($id != null) {
            $reposNivosliderItem = $this->getDoctrine()->getRepository(Nivoslider\Item::class);
    ...
    public function itemnivostatusAction($id = null, Request $request) {
        $nivoslider = $this->getDoctrine()->getRepository(Nivoslider::class)->findOneById($id);
    ...
    public function itemlistnivoAction() {
        $nivosliders = $this->getDoctrine()->getRepository(Nivoslider::class)->findAll();
