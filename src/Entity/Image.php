...
class Image {
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Image\Size", inversedBy="images")
     * @ORM\JoinTable(name="images_sizes")
     */
    private $sizes;

    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Content", mappedBy="images")
     */
    private $contents;
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Payment\Lang\Label", mappedBy="image")
     */
...
//    protected $file;
     ...
     * Add size
     *
     * @param \App\Entity\Image\Size $size
     *
     * @return Image
     */
    public function addSize(\App\Entity\Image\Size $size) {
        $this->sizes[] = $size;
     ...
     * @param \App\Entity\Image\Size $size
     */
    public function removeSize(\App\Entity\Image\Size $size) {
