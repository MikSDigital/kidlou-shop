...
class Mail {
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Mail\Send", mappedBy="mail")
     */
    private $sends;
     ...
     * Add send
     *
     * @param \App\Entity\Mail\Send $send
     *
     * @return Mail
     */
    public function addSend(\App\Entity\Mail\Send $send) {
        $this->sends[] = $send;
     ...
     * @param \App\Entity\Mail\Send $send
     */
    public function removeSend(\App\Entity\Mail\Send $send) {
