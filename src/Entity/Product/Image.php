...
class Image {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Product\Image\Size", inversedBy="images")
...
//    protected $file;
     ...
     * Set size
     *
     * @param \App\Entity\Product\Image\Size $size
     *
     * @return Image
     */
    public function setSize(\App\Entity\Product\Image\Size $size = null)
    {
        $this->size = $size;
     ...
     * Get size
     *
     * @return \App\Entity\Product\Image\Size
     */
