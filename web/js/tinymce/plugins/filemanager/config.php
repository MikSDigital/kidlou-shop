...
$upload_dir = '/media/tinymce/source/'; // path from base_url to upload base dir
//$current_path = '../../../../source/'; // relative path from filemanager folder to upload files folder
$current_path = '../../../../media/tinymce/source/'; // relative path from filemanager folder to upload files folder
